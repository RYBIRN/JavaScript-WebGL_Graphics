		class WebGL_Interface
		{
			constructor()
			{
				...
				gl.uniform3fv(camLoc,new Float32Array([-6.0,0.0,-6.0]));
				var worldLoc = gl.getUniformLocation(this.program,'worldRotation');
				gl.uniform3fv(worldLoc,new Float32Array([0,0,0]));
				  var lightWorldPosition = gl.getUniformLocation(this.program, 'lightPosition');
				  gl.uniform3fv(lightWorldPosition,new Float32Array([5.0,0.0,-2.0]));
			}
